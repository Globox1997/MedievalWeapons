...
public class CompatEntities {
    ...
    public static void loadEntities() {
        if (CompatItems.isBetterEndLoaded) {
            TERMINITE_FRANCISCA = EntityInit.register("terminite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.TERMINITE_FRANCISCA_ITEM));
            TERMINITE_JAVELIN = EntityInit.register("terminite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.TERMINITE_JAVELIN_ITEM));
            AETERNIUM_FRANCISCA = EntityInit.register("aeternium_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.AETERNIUM_FRANCISCA_ITEM));
            AETERNIUM_JAVELIN = EntityInit.register("aeternium_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.AETERNIUM_JAVELIN_ITEM));
            THALLASIUM_FRANCISCA = EntityInit.register("thallasium_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.THALLASIUM_FRANCISCA_ITEM));
            THALLASIUM_JAVELIN = EntityInit.register("thallasium_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.THALLASIUM_JAVELIN_ITEM));
        ...
        if (CompatItems.isBetterNetherLoaded) {
            NETHER_RUBY_FRANCISCA = EntityInit.register("nether_ruby_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.NETHER_RUBY_FRANCISCA_ITEM));
            NETHER_RUBY_JAVELIN = EntityInit.register("nether_ruby_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.NETHER_RUBY_JAVELIN_ITEM));
            CINCINNASITE_FRANCISCA = EntityInit.register("cincinnasite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.CINCINNASITE_FRANCISCA_ITEM));
            CINCINNASITE_JAVELIN = EntityInit.register("cincinnasite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.CINCINNASITE_JAVELIN_ITEM));
            CINCINNASITE_DIAMOND_FRANCISCA = EntityInit.register("cincinnasite_diamond_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.CINCINNASITE_DIAMOND_FRANCISCA_ITEM));
            CINCINNASITE_DIAMOND_JAVELIN = EntityInit.register("cincinnasite_diamond_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.CINCINNASITE_DIAMOND_JAVELIN_ITEM));
        ...
        if (CompatItems.isDragonLootLoaded) {
            DRAGON_JAVELIN = EntityInit.register("dragon_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.DRAGON_JAVELIN_ITEM));
            DRAGON_FRANCISCA = EntityInit.register("dragon_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.DRAGON_FRANCISCA_ITEM));
        ...
        if (CompatItems.isMythicMetalsLoaded) {
            ADAMANTITE_JAVELIN = EntityInit.register("adamantite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.ADAMANTITE_JAVELIN_ITEM));
            ADAMANTITE_FRANCISCA = EntityInit.register("adamantite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.ADAMANTITE_FRANCISCA_ITEM));
        ...
        if (CompatItems.isParadiseLostLoaded) {
            OLVITE_JAVELIN = EntityInit.register("olvite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.OLVITE_JAVELIN_ITEM));
            OLVITE_FRANCISCA = EntityInit.register("olvite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.OLVITE_FRANCISCA_ITEM));
        ...
        if (CompatItems.isBYGLoaded) {
            PENDORITE_JAVELIN = EntityInit.register("pendorite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.PENDORITE_JAVELIN_ITEM));
            PENDORITE_FRANCISCA = EntityInit.register("pendorite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.PENDORITE_FRANCISCA_ITEM));
        ...
        if (CompatItems.isAdditionalAdditionsLoaded) {
            ROSE_GOLD_JAVELIN = EntityInit.register("rose_gold_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.ROSE_GOLD_JAVELIN_ITEM));
            ROSE_GOLD_FRANCISCA = EntityInit.register("rose_gold_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.ROSE_GOLD_FRANCISCA_ITEM));
            GILDED_NETHERITE_JAVELIN = EntityInit.register("gilded_netherite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.GILDED_NETHERITE_JAVELIN_ITEM));
            GILDED_NETHERITE_FRANCISCA = EntityInit.register("gilded_netherite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.GILDED_NETHERITE_FRANCISCA_ITEM));
        ...
        if (CompatItems.isMythicUpgradesLoaded) {
            RUBY_NETHERITE_JAVELIN = EntityInit.register("ruby_netherite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.RUBY_NETHERITE_JAVELIN_ITEM));
            RUBY_NETHERITE_FRANCISCA = EntityInit.register("ruby_netherite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.RUBY_NETHERITE_FRANCISCA_ITEM));
            SAPPHIRE_NETHERITE_JAVELIN = EntityInit.register("sapphire_netherite_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.SAPPHIRE_NETHERITE_JAVELIN_ITEM));
            SAPPHIRE_NETHERITE_FRANCISCA = EntityInit.register("sapphire_netherite_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.SAPPHIRE_NETHERITE_FRANCISCA_ITEM));
        ...
        if (CompatItems.isDeeperDarkerLoaded) {
            WARDEN_JAVELIN = EntityInit.register("warden_javelin", EntityInit.create_Javelin((JavelinItem) CompatItems.WARDEN_JAVELIN_ITEM));
            WARDEN_FRANCISCA = EntityInit.register("warden_francisca", EntityInit.create_Francisca((FranciscaItem) CompatItems.WARDEN_FRANCISCA_ITEM));
