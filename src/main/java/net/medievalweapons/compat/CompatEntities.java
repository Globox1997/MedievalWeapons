...
public class CompatEntities {
        // DragonLoot
        public static final EntityType<Javelin_Entity> DRAGON_JAVELIN = EntityInit.register("dragon_javelin",
                        EntityInit.create_Javelin(CompatItems.DRAGON_JAVELIN_ITEM));
        public static final EntityType<Francisca_HT_Entity> DRAGON_FRANCISCA_HT = EntityInit.register(
                        "dragon_francisca", EntityInit.create_HT_Francisca(CompatItems.DRAGON_FRANCISCA_HT_ITEM));
        // Better Nether
        public static final EntityType<Francisca_HT_Entity> NETHER_RUBY_FRANCISCA_HT = EntityInit.register(
                        "nether_ruby_francisca",
                        EntityInit.create_HT_Francisca(CompatItems.NETHER_RUBY_FRANCISCA_HT_ITEM));
        public static final EntityType<Javelin_Entity> NETHER_RUBY_JAVELIN = EntityInit.register("nether_ruby_javelin",
                        EntityInit.create_Javelin(CompatItems.NETHER_RUBY_JAVELIN_ITEM));
        public static final EntityType<Francisca_HT_Entity> CINCINNASITE_FRANCISCA_HT = EntityInit.register(
                        "cincinnasite_francisca",
                        EntityInit.create_HT_Francisca(CompatItems.CINCINNASITE_FRANCISCA_HT_ITEM));
        public static final EntityType<Javelin_Entity> CINCINNASITE_JAVELIN = EntityInit.register(
                        "cincinnasite_javelin", EntityInit.create_Javelin(CompatItems.CINCINNASITE_JAVELIN_ITEM));
        public static final EntityType<Francisca_HT_Entity> CINCINNASITE_DIAMOND_FRANCISCA_HT = EntityInit.register(
                        "cincinnasite_diamond_francisca",
                        EntityInit.create_HT_Francisca(CompatItems.CINCINNASITE_DIAMOND_FRANCISCA_HT_ITEM));
        public static final EntityType<Javelin_Entity> CINCINNASITE_DIAMOND_JAVELIN = EntityInit.register(
                        "cincinnasite_diamond_javelin",
                        EntityInit.create_Javelin(CompatItems.CINCINNASITE_DIAMOND_JAVELIN_ITEM));
        // Better End
        public static final EntityType<Francisca_HT_Entity> TERMINITE_FRANCISCA_HT = EntityInit.register(
                        "terminite_francisca", EntityInit.create_HT_Francisca(CompatItems.TERMINITE_FRANCISCA_HT_ITEM));
        public static final EntityType<Javelin_Entity> TERMINITE_JAVELIN = EntityInit.register("terminite_javelin",
                        EntityInit.create_Javelin(CompatItems.TERMINITE_JAVELIN_ITEM));
        public static final EntityType<Francisca_HT_Entity> AETERNIUM_FRANCISCA_HT = EntityInit.register(
                        "aeternium_francisca", EntityInit.create_HT_Francisca(CompatItems.AETERNIUM_FRANCISCA_HT_ITEM));
        public static final EntityType<Javelin_Entity> AETERNIUM_JAVELIN = EntityInit.register("aeternium_javelin",
                        EntityInit.create_Javelin(CompatItems.AETERNIUM_JAVELIN_ITEM));
        public static final EntityType<Francisca_HT_Entity> THALLASIUM_FRANCISCA_HT = EntityInit.register(
                        "thallasium_francisca",
                        EntityInit.create_HT_Francisca(CompatItems.THALLASIUM_FRANCISCA_HT_ITEM));
        public static final EntityType<Javelin_Entity> THALLASIUM_JAVELIN = EntityInit.register("thallasium_javelin",
