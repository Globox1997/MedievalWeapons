...
public class CompatItems {
    ...
    public static void loadItems() {
        if (isBetterEndLoaded) {
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("terminite_long_sword"), new Long_Sword_Item(EndToolMaterial.TERMINITE, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP)));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("terminite_mace"), new Mace_Item(EndToolMaterial.TERMINITE, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP)));
            TERMINITE_FRANCISCA_HT_ITEM = ItemInit.register("terminite_francisca",
                    new Francisca_HT_Item(EndToolMaterial.TERMINITE, 2.0F, -2.6F, () -> CompatEntities.TERMINITE_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP)));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("aeternium_long_sword"), new Long_Sword_Item(EndToolMaterial.AETERNIUM, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP)));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("aeternium_mace"), new Mace_Item(EndToolMaterial.AETERNIUM, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP)));
            AETERNIUM_FRANCISCA_HT_ITEM = ItemInit.register("aeternium_francisca",
                    new Francisca_HT_Item(EndToolMaterial.AETERNIUM, 2.0F, -2.6F, () -> CompatEntities.AETERNIUM_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP)));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("thallasium_long_sword"), new Long_Sword_Item(EndToolMaterial.THALLASIUM, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP)));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("thallasium_mace"), new Mace_Item(EndToolMaterial.THALLASIUM, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP)));
            THALLASIUM_FRANCISCA_HT_ITEM = ItemInit.register("thallasium_francisca",
                    new Francisca_HT_Item(EndToolMaterial.THALLASIUM, 2.0F, -2.6F, () -> CompatEntities.THALLASIUM_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP)));
        ...
        if (isBetterNetherLoaded) {
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_small_axe"), new Small_Axe_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 5, -2.9F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_long_sword"), new Long_Sword_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_dagger"), new Dagger_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 2, -2.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_big_axe"), new Big_Axe_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_lance"), new Lance_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_healing_staff"),
                    new Healing_Staff_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 1, -3.3F, 4, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_mace"), new Mace_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            NETHER_RUBY_FRANCISCA_HT_ITEM = ItemInit.register("nether_ruby_francisca",
                    new Francisca_HT_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 2.0F, -2.6F, () -> CompatEntities.NETHER_RUBY_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            NETHER_RUBY_JAVELIN_ITEM = ItemInit.register("nether_ruby_javelin",
                    new Javelin_Item(BNItemMaterials.NETHER_RUBY_TOOLS, 2.2F, -2.7F, () -> CompatEntities.NETHER_RUBY_JAVELIN, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_small_axe"), new Small_Axe_Item(BNItemMaterials.CINCINNASITE_TOOLS, 5, -2.9F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_long_sword"),
                    new Long_Sword_Item(BNItemMaterials.CINCINNASITE_TOOLS, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_dagger"), new Dagger_Item(BNItemMaterials.CINCINNASITE_TOOLS, 2, -2.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_big_axe"), new Big_Axe_Item(BNItemMaterials.CINCINNASITE_TOOLS, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_lance"), new Lance_Item(BNItemMaterials.CINCINNASITE_TOOLS, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_healing_staff"),
                    new Healing_Staff_Item(BNItemMaterials.CINCINNASITE_TOOLS, 1, -3.3F, 4, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_mace"), new Mace_Item(BNItemMaterials.CINCINNASITE_TOOLS, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            CINCINNASITE_FRANCISCA_HT_ITEM = ItemInit.register("cincinnasite_francisca",
                    new Francisca_HT_Item(BNItemMaterials.CINCINNASITE_TOOLS, 2.0F, -2.6F, () -> CompatEntities.CINCINNASITE_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            CINCINNASITE_JAVELIN_ITEM = ItemInit.register("cincinnasite_javelin",
                    new Javelin_Item(BNItemMaterials.CINCINNASITE_TOOLS, 2.2F, -2.7F, () -> CompatEntities.CINCINNASITE_JAVELIN, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_small_axe"),
                    new Small_Axe_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 5, -2.9F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_long_sword"),
                    new Long_Sword_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_dagger"),
                    new Dagger_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 2, -2.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_big_axe"),
                    new Big_Axe_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_lance"),
                    new Lance_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_healing_staff"),
                    new Healing_Staff_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 1, -3.3F, 5, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_mace"),
                    new Mace_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 4, -3.0F, 3, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            CINCINNASITE_DIAMOND_FRANCISCA_HT_ITEM = ItemInit.register("cincinnasite_diamond_francisca", new Francisca_HT_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 2.0F, -2.6F,
                    () -> CompatEntities.CINCINNASITE_DIAMOND_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            CINCINNASITE_DIAMOND_JAVELIN_ITEM = ItemInit.register("cincinnasite_diamond_javelin", new Javelin_Item(BNItemMaterials.CINCINNASITE_DIAMOND_TOOLS, 2.2F, -2.7F,
                    () -> CompatEntities.CINCINNASITE_DIAMOND_JAVELIN, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        ...
        if (isDragonLootLoaded) {
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("dragon_long_sword"), new Long_Sword_Item(DragonToolMaterial.getInstance(), 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("dragon_mace"), new Mace_Item(DragonToolMaterial.getInstance(), 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            DRAGON_FRANCISCA_HT_ITEM = ItemInit.register("dragon_francisca",
                    new Francisca_HT_Item(DragonToolMaterial.getInstance(), 2.0F, -2.6F, () -> CompatEntities.DRAGON_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
