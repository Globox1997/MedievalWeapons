...
public class CompatItems {
    ...
    public static void loadItems() {
        ...
        if (isBetterNetherLoaded) {
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_long_sword"), new Long_Sword_Item(BNToolMaterial.NETHER_RUBY, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("nether_ruby_mace"), new Mace_Item(BNToolMaterial.NETHER_RUBY, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            NETHER_RUBY_FRANCISCA_HT_ITEM = ItemInit.register("nether_ruby_francisca",
                    new Francisca_HT_Item(BNToolMaterial.NETHER_RUBY, 2.0F, -2.6F, () -> CompatEntities.NETHER_RUBY_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_long_sword"), new Long_Sword_Item(BNToolMaterial.CINCINNASITE, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_mace"), new Mace_Item(BNToolMaterial.CINCINNASITE, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            CINCINNASITE_FRANCISCA_HT_ITEM = ItemInit.register("cincinnasite_francisca",
                    new Francisca_HT_Item(BNToolMaterial.CINCINNASITE, 2.0F, -2.6F, () -> CompatEntities.CINCINNASITE_FRANCISCA_HT, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_long_sword"),
                    new Long_Sword_Item(BNToolMaterial.CINCINNASITE_DIAMOND, 5, -3.0F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            ...
            ItemInit.ITEMS.put(MedievalMain.ID("cincinnasite_diamond_mace"),
                    new Mace_Item(BNToolMaterial.CINCINNASITE_DIAMOND, 4, -3.0F, 3, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
            CINCINNASITE_DIAMOND_FRANCISCA_HT_ITEM = ItemInit.register("cincinnasite_diamond_francisca", new Francisca_HT_Item(BNToolMaterial.CINCINNASITE_DIAMOND, 2.0F, -2.6F,
