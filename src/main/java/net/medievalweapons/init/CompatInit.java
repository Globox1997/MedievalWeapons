...
public class CompatInit {
    ...
    // public static final RegistryEntry<EntityAttribute> ATTACK_RANGE = new ClampedEntityAttribute("attribute.name.generic.attack_range", 0.0D, -1204.0D, 1024.0D).setTracked(true);
    ...
    //         builder.put(EntityAttributes.PLAYER_ENTITY_INTERACTION_RANGE, new EntityAttributeModifier("Attack range", range, EntityAttributeModifier.Operation.ADDITION));
    //         // } else {
