...
public class ModelProviderInit {
    ...
    public static void init() {
        ...
        ModelPredicateProviderRegistry.register(Identifier.of("medievalweapons", "offhand"), (stack, world, entity, seed) -> {
        ...
        ModelPredicateProviderRegistry.register(Identifier.of("medievalweapons", "gui"), (stack, world, entity, seed) -> {
    ...
    public static ModelJsonBuilder getModelJsonBuilder(String item, String material) {
        ...
        case "big_axe":
            return ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
