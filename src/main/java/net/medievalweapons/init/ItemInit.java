...
public class ItemInit {
        ...
        public static final Big_Axe_Item WOODEN_BIG_AXE_ITEM = register("wooden_big_axe",
                        new Big_Axe_Item(ToolMaterials.WOOD, 6, -3.4F, () -> EntityInit.WOODEN_BIG_AXE,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item STONE_BIG_AXE_ITEM = register("stone_big_axe",
                        new Big_Axe_Item(ToolMaterials.STONE, 6, -3.4F, () -> EntityInit.STONE_BIG_AXE,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item IRON_BIG_AXE_ITEM = register("iron_big_axe",
                        new Big_Axe_Item(ToolMaterials.IRON, 6, -3.4F, () -> EntityInit.IRON_BIG_AXE,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item GOLDEN_BIG_AXE_ITEM = register("golden_big_axe",
                        new Big_Axe_Item(ToolMaterials.GOLD, 6, -3.4F, () -> EntityInit.GOLDEN_BIG_AXE,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item DIAMOND_BIG_AXE_ITEM = register("diamond_big_axe",
                        new Big_Axe_Item(ToolMaterials.DIAMOND, 6, -3.4F, () -> EntityInit.DIAMOND_BIG_AXE,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item NETHERITE_BIG_AXE_ITEM = register("netherite_big_axe",
                        new Big_Axe_Item(ToolMaterials.NETHERITE, 6, -3.4F, () -> EntityInit.NETHERITE_BIG_AXE,
                                        new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Javelin
        ...
        public static final Healing_Staff_Item NETHERITE_HEALING_STAFF_ITEM = register("netherite_healing_staff",
                        new Healing_Staff_Item(ToolMaterials.NETHERITE, 1, -3.3F, 5,
                                        ...
                                        new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Mace
        public static final Mace_Item WOODEN_MACE_ITEM = register("wooden_mace", new Mace_Item(ToolMaterials.WOOD, 4,
                        -3.0F, 0, () -> EntityInit.WOODEN_MACE, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item STONE_MACE_ITEM = register("stone_mace", new Mace_Item(ToolMaterials.STONE, 4,
                        -3.0F, 0, () -> EntityInit.STONE_MACE, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item IRON_MACE_ITEM = register("iron_mace", new Mace_Item(ToolMaterials.IRON, 4, -3.0F,
                        1, () -> EntityInit.IRON_MACE, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item GOLDEN_MACE_ITEM = register("golden_mace", new Mace_Item(ToolMaterials.GOLD, 4,
                        -3.0F, 2, () -> EntityInit.GOLDEN_MACE, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item DIAMOND_MACE_ITEM = register("diamond_mace", new Mace_Item(ToolMaterials.DIAMOND,
                        3, -3.0F, 2, () -> EntityInit.DIAMOND_MACE, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item NETHERITE_MACE_ITEM = register("netherite_mace",
                        new Mace_Item(ToolMaterials.NETHERITE, 4, -3.0F, 3, () -> EntityInit.NETHERITE_MACE,
                                        new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Long Bow
        ...
        // Thalleous Sword
        public static final Thalleous_Sword_Item THALLEOUS_SWORD = register("thalleous_sword",
                        new Thalleous_Sword_Item(ToolMaterials.DIAMOND, 10, -3.0F, () -> EntityInit.THALLEOUS_SWORD,
                                        new Item.Settings().group(MedievalMain.GROUP)));
