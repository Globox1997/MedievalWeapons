...
public class ItemInit {
        ...
        public static final Big_Axe_Item STONE_BIG_AXE_ITEM = register("stone_big_axe",
                        new Big_Axe_Item(ToolMaterials.STONE, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item IRON_BIG_AXE_ITEM = register("iron_big_axe",
                        new Big_Axe_Item(ToolMaterials.IRON, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item GOLDEN_BIG_AXE_ITEM = register("golden_big_axe",
                        new Big_Axe_Item(ToolMaterials.GOLD, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item DIAMOND_BIG_AXE_ITEM = register("diamond_big_axe", new Big_Axe_Item(
                        ToolMaterials.DIAMOND, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Big_Axe_Item NETHERITE_BIG_AXE_ITEM = register("netherite_big_axe", new Big_Axe_Item(
                        ToolMaterials.NETHERITE, 6, -3.4F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Javelin
        ...
        public static final Javelin_Item NETHERITE_JAVELIN_ITEM = register("netherite_javelin",
                        new Javelin_Item(ToolMaterials.NETHERITE, 2.2F, -2.7F, () -> EntityInit.NETHERITE_JAVELIN,
                                        new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Lance
        public static final Lance_Item WOODEN_LANCE_ITEM = register("wooden_lance",
                        new Lance_Item(ToolMaterials.WOOD, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Lance_Item STONE_LANCE_ITEM = register("stone_lance",
                        new Lance_Item(ToolMaterials.STONE, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Lance_Item IRON_LANCE_ITEM = register("iron_lance",
                        new Lance_Item(ToolMaterials.IRON, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Lance_Item GOLDEN_LANCE_ITEM = register("golden_lance",
                        new Lance_Item(ToolMaterials.GOLD, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Lance_Item DIAMOND_LANCE_ITEM = register("diamond_lance",
                        new Lance_Item(ToolMaterials.DIAMOND, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Lance_Item NETHERITE_LANCE_ITEM = register("netherite_lance", new Lance_Item(
                        ToolMaterials.NETHERITE, 3, -3.2F, new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Healing Staff
        public static final Healing_Staff_Item WOODEN_HEALING_STAFF_ITEM = register("wooden_healing_staff",
                        new Healing_Staff_Item(ToolMaterials.WOOD, 1, -3.3F, 1,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Healing_Staff_Item STONE_HEALING_STAFF_ITEM = register("stone_healing_staff",
                        new Healing_Staff_Item(ToolMaterials.STONE, 1, -3.3F, 2,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Healing_Staff_Item IRON_HEALING_STAFF_ITEM = register("iron_healing_staff",
                        new Healing_Staff_Item(ToolMaterials.IRON, 1, -3.3F, 3,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        public static final Healing_Staff_Item GOLDEN_HEALING_STAFF_ITEM = register("golden_healing_staff",
                        new Healing_Staff_Item(ToolMaterials.GOLD, 1, -3.3F, 3,
                                        new Item.Settings().group(MedievalMain.GROUP)));
        ...
        public static final Healing_Staff_Item NETHERITE_HEALING_STAFF_ITEM = register("netherite_healing_staff",
                        new Healing_Staff_Item(ToolMaterials.NETHERITE, 1, -3.3F, 5,
                                        new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Mace
        public static final Mace_Item WOODEN_MACE_ITEM = register("wooden_mace",
                        new Mace_Item(ToolMaterials.WOOD, 4, -3.0F, 0, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item STONE_MACE_ITEM = register("stone_mace",
                        new Mace_Item(ToolMaterials.STONE, 4, -3.0F, 0, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item IRON_MACE_ITEM = register("iron_mace",
                        new Mace_Item(ToolMaterials.IRON, 4, -3.0F, 1, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item GOLDEN_MACE_ITEM = register("golden_mace",
                        new Mace_Item(ToolMaterials.GOLD, 4, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item DIAMOND_MACE_ITEM = register("diamond_mace", new Mace_Item(ToolMaterials.DIAMOND,
                        3, -3.0F, 2, new Item.Settings().group(MedievalMain.GROUP)));
        public static final Mace_Item NETHERITE_MACE_ITEM = register("netherite_mace",
                        new Mace_Item(ToolMaterials.NETHERITE, 4, -3.0F, 3,
                                        new Item.Settings().group(MedievalMain.GROUP).fireproof()));
        // Long Bow
