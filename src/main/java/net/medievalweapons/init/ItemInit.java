...
public static final Small_Axe_Item DIAMOND_SMALL_AXE_ITEM = register("diamond_small_axe", new Small_Axe_Item(Tiers.DIAMOND, 5, -2.9F, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Small_Axe_Item NETHERITE_SMALL_AXE_ITEM = register("netherite_small_axe",
            new Small_Axe_Item(Tiers.NETHERITE, 5, -2.9F, new Item.Properties().tab(MedievalMain.GROUP).fireproof()));
    // Long Sword
    ...
    public static final Long_Sword_Item NETHERITE_LONG_SWORD_ITEM = register("netherite_long_sword",
            new Long_Sword_Item(Tiers.NETHERITE, 6, -3.0F, new Item.Properties().tab(MedievalMain.GROUP).fireproof()));
    // Dagger
    ...
    public static final Dagger_Item NETHERITE_DAGGER_ITEM = register("netherite_dagger",
            new Dagger_Item(Tiers.NETHERITE, 2, -2.0F, new Item.Properties().tab(MedievalMain.GROUP).fireproof()));
    // Francisca
    ...
    public static final Mace_Item DIAMOND_MACE_ITEM = register("diamond_mace", new Mace_Item(Tiers.DIAMOND, 4, -2.8F, 2, new Item.Properties().tab(MedievalMain.GROUP)));
    ...
    // Sickle
    public static final Sickle_Item WOODEN_SICKLE_ITEM = register("wooden_sickle", new Sickle_Item(Tiers.WOOD, 2, -2.3F, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Sickle_Item STONE_SICKLE_ITEM = register("stone_sickle", new Sickle_Item(Tiers.STONE, 2, -2.3F, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Sickle_Item IRON_SICKLE_ITEM = register("iron_sickle", new Sickle_Item(Tiers.IRON, 2, -2.3F, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Sickle_Item GOLDEN_SICKLE_ITEM = register("golden_sickle", new Sickle_Item(Tiers.GOLD, 2, -2.3F, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Sickle_Item DIAMOND_SICKLE_ITEM = register("diamond_sickle", new Sickle_Item(Tiers.DIAMOND, 2, -2.3F, new Item.Properties().tab(MedievalMain.GROUP)));
    ...
    // Rapier
    public static final Rapier_Item WOODEN_RAPIER_ITEM = register("wooden_rapier", new Rapier_Item(Tiers.WOOD, 3, -2.0F, 0, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Rapier_Item STONE_RAPIER_ITEM = register("stone_rapier", new Rapier_Item(Tiers.STONE, 3, -2.0F, 0, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Rapier_Item IRON_RAPIER_ITEM = register("iron_rapier", new Rapier_Item(Tiers.IRON, 3, -2.0F, 1, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Rapier_Item GOLDEN_RAPIER_ITEM = register("golden_rapier", new Rapier_Item(Tiers.GOLD, 3, -2.0F, 2, new Item.Properties().tab(MedievalMain.GROUP)));
    public static final Rapier_Item DIAMOND_RAPIER_ITEM = register("diamond_rapier", new Rapier_Item(Tiers.DIAMOND, 3, -2.0F, 2, new Item.Properties().tab(MedievalMain.GROUP)));
    ...
    public static void init() {
        ...
        for (Identifier id : ITEMS.keySet()) {
            Registry.register(Registry.ITEM, (ResourceLocation) id, ITEMS.get(id));
        }
    }
