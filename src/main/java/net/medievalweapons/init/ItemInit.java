...
public class ItemInit {
    ...
    public static final FranciscaItem STONE_FRANCISCA_ITEM = register("stone_francisca",
    ...
    public static final FranciscaItem IRON_FRANCISCA_ITEM = register("iron_francisca",
    ...
    public static final FranciscaItem GOLDEN_FRANCISCA_ITEM = register("golden_francisca",
    ...
    public static final FranciscaItem DIAMOND_FRANCISCA_ITEM = register("diamond_francisca",
    ...
    public static final FranciscaItem NETHERITE_FRANCISCA_ITEM = register("netherite_francisca", new FranciscaItem(ToolMaterials.NETHERITE, () -> EntityInit.NETHERITE_FRANCISCA,
    ...
    public static final JavelinItem STONE_JAVELIN_ITEM = register("stone_javelin",
    ...
    public static final JavelinItem IRON_JAVELIN_ITEM = register("iron_javelin",
    ...
    public static final JavelinItem GOLDEN_JAVELIN_ITEM = register("golden_javelin",
    ...
    public static final JavelinItem DIAMOND_JAVELIN_ITEM = register("diamond_javelin",
    ...
    public static final JavelinItem NETHERITE_JAVELIN_ITEM = register("netherite_javelin", new JavelinItem(ToolMaterials.NETHERITE, () -> EntityInit.NETHERITE_JAVELIN,
    ...
    public static final HealingStaffItem STONE_HEALING_STAFF_ITEM = register("stone_healing_staff",
    ...
    public static final HealingStaffItem IRON_HEALING_STAFF_ITEM = register("iron_healing_staff",
    ...
    public static final HealingStaffItem GOLDEN_HEALING_STAFF_ITEM = register("golden_healing_staff",
    ...
    public static final HealingStaffItem DIAMOND_HEALING_STAFF_ITEM = register("diamond_healing_staff",
    ...
    public static final HealingStaffItem NETHERITE_HEALING_STAFF_ITEM = register("netherite_healing_staff",
    ...
    public static final NinjatoItem STONE_NINJATO_ITEM = register("stone_ninjato",
    ...
    public static final NinjatoItem IRON_NINJATO_ITEM = register("iron_ninjato",
    ...
    public static final NinjatoItem GOLDEN_NINJATO_ITEM = register("golden_ninjato",
    ...
    public static final NinjatoItem DIAMOND_NINJATO_ITEM = register("diamond_ninjato",
    ...
    public static final NinjatoItem NETHERITE_NINJATO_ITEM = register("netherite_ninjato",
    ...
    // Sickle
    public static final SickleItem WOODEN_SICKLE_ITEM = register("wooden_sickle",
    ...
    public static final SickleItem IRON_SICKLE_ITEM = register("iron_sickle",
    ...
    public static final SickleItem GOLDEN_SICKLE_ITEM = register("golden_sickle",
    ...
    public static final SickleItem DIAMOND_SICKLE_ITEM = register("diamond_sickle",
    ...
    public static final SickleItem NETHERITE_SICKLE_ITEM = register("netherite_sickle",
    ...
    public static final RapierItem WOODEN_RAPIER_ITEM = register("wooden_rapier",
    ...
    public static final RapierItem STONE_RAPIER_ITEM = register("stone_rapier",
    ...
    public static final RapierItem IRON_RAPIER_ITEM = register("iron_rapier",
    ...
    public static final RapierItem GOLDEN_RAPIER_ITEM = register("golden_rapier",
    ...
    public static final RapierItem DIAMOND_RAPIER_ITEM = register("diamond_rapier",
    ...
    public static final RapierItem NETHERITE_RAPIER_ITEM = register("netherite_rapier",
    ...
    // Long Bow
    public static final LongBowItem LONG_BOW_ITEM = register("long_bow", new LongBowItem(new Item.Settings().maxDamage(443)));
    // Recurve Bow
