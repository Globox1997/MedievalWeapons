...
public class ModelInit {
    ...
    public static void init() {
        ModelPredicateProviderRegistry.register(ItemInit.LONG_BOW_ITEM, Identifier.of("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            } else {
                return entity.getActiveItem() != stack ? 0.0F : (float) (stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft()) / 50.0F;
            }
        });
        ModelPredicateProviderRegistry.register(ItemInit.LONG_BOW_ITEM, Identifier.of("pulling"), (stack, world, entity, seed) -> {
            return entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F;
        });
        ModelPredicateProviderRegistry.register(ItemInit.RECURVE_BOW_ITEM, Identifier.of("pull"), (stack, world, entity, seed) -> {
            if (entity == null) {
                return 0.0F;
            } else {
                return entity.getActiveItem() != stack ? 0.0F : (float) (stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft()) / 16.0F;
            }
        });
        ModelPredicateProviderRegistry.register(ItemInit.RECURVE_BOW_ITEM, Identifier.of("pulling"), (stack, world, entity, seed) -> {
            return entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F;
        });
        ModelPredicateProviderRegistry.register(MedievalMain.identifierOf("offhand"), (stack, world, entity, seed) -> {
        ...
        ModelPredicateProviderRegistry.register(MedievalMain.identifierOf("gui"), (stack, world, entity, seed) -> {
        ...
        if (CompatInit.isARRPLoaded) {
            ...
            BRRP_RESOURCE_PACK = pers.solid.brrp.v1.api.RuntimeResourcePack.create(Identifier.of("medievalweapons", "weapons"));
            // Generate models
            for (String item : ItemInit.ITEM_STRINGS) {
                for (int i = 0; i < ItemInit.MATERIAL_STRINGS.size(); i++) {
                    BRRP_RESOURCE_PACK.addModel(Identifier.of("medievalweapons", "item/" + ItemInit.MATERIAL_STRINGS.get(i) + "_" + item),
                            getModelJsonBuilder(item, ItemInit.MATERIAL_STRINGS.get(i)));
                    // Check for gui item models
                    if (item.equals("big_axe") || item.equals("healing_staff") || item.equals("javelin") || item.equals("lance") || item.equals("long_sword") || item.equals("mace")
                            || item.equals("rapier") || item.equals("sickle") || item.equals("small_axe")) {
                        BRRP_RESOURCE_PACK.addModel(Identifier.of("medievalweapons", "item/" + ItemInit.MATERIAL_STRINGS.get(i) + "_" + item + "_gui"),
                                getGuiModelJsonBuilder(item, ItemInit.MATERIAL_STRINGS.get(i)));
                    }
                    // Check for bc item models
                    if (item.equals("dagger") || item.equals("big_axe") || item.equals("lance") || item.equals("long_sword")) {
                        BRRP_RESOURCE_PACK.addModel(Identifier.of("medievalweapons", "item/bc_" + ItemInit.MATERIAL_STRINGS.get(i) + "_" + item),
                                getOtherModelJsonBuilder(item, ItemInit.MATERIAL_STRINGS.get(i)));
                    }
                    // Check BRRP_RESOURCE_PACK throwing item models
                    if (item.equals("javelin")) {
                        BRRP_RESOURCE_PACK.addModel(Identifier.of("medievalweapons", "item/" + ItemInit.MATERIAL_STRINGS.get(i) + "_" + item + "_throwing"),
                                getOtherModelJsonBuilder(item, ItemInit.MATERIAL_STRINGS.get(i)));
                    }
                }
            }
    ...
    private static JModel getJModel(String item, String material) {
        return switch (item) {
            case "big_axe" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("bettercombat:loaded", 1.0f), Identifier.of("medievalweapons:item/bc_" + material + "_" + item)))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:offhand", 1.0f), Identifier.of("medievalweapons:item/bc_" + material + "_" + item)))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "dagger" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("bettercombat:loaded", 1.0f), Identifier.of("medievalweapons:item/bc_" + material + "_" + item)))
            ...
            case "francisca" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item));
            case "healing_staff" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "javelin" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("throwing", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_throwing")))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "lance" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("bettercombat:loaded", 1.0f), Identifier.of("medievalweapons:item/bc_" + material + "_" + item)))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "long_sword" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("bettercombat:loaded", 1.0f), Identifier.of("medievalweapons:item/bc_" + material + "_" + item)))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:offhand", 1.0f), Identifier.of("medievalweapons:item/bc_" + material + "_" + item)))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "mace" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "ninjato" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item));
            case "rapier" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "sickle" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            case "small_axe" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .addOverride(JModel.override(JModel.condition().parameter("medievalweapons:gui", 1.0f), Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui")))
            ...
            default -> throw new IllegalStateException("Could not find JModel!");
        };
    }
        ...
        return switch (item) {
            ...
            case "long_sword" -> JModel.model().parent("item/handheld").textures(JModel.textures().layer0("medievalweapons:item/" + material + "_" + item))
                    .display(JModel.display().setThirdperson_righthand(JModel.position().rotation(0f, 90f, 35f).translation(0f, 13f, -1f).scale(1.7f, 1.7f, 0.85f))
                            ...
                            .setGround(JModel.position().translation(0f, 4f, 0f).scale(1f, 1f, 0.68f)).setHead(JModel.position().translation(5.5f, 9f, 0f).scale(2f, 2f, 1f))
                            .setFixed(JModel.position().rotation(0, -180f, 0f).translation(-4.25f, 4.25f, -0.5f).scale(1.5f, 1.5f, 1f)));
            default -> throw new IllegalStateException("Could not find BCJModel!");
        };
    }
    ...
    public static ModelJsonBuilder getModelJsonBuilder(String item, String material) {
        return switch (item) {
            case "big_axe" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/bc_" + material + "_" + item), Identifier.of("bettercombat:loaded"), 1.0f))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/bc_" + material + "_" + item), Identifier.of("medievalweapons:offhand"), 1.0f))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "dagger" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/bc_" + material + "_" + item), Identifier.of("bettercombat:loaded"), 1.0f))
            ...
            case "francisca" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item));
            case "healing_staff" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "javelin" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_throwing"), Identifier.of("throwing"), 1.0f))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "lance" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/bc_" + material + "_" + item), Identifier.of("bettercombat:loaded"), 1.0f))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "long_sword" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/bc_" + material + "_" + item), Identifier.of("bettercombat:loaded"), 1.0f))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/bc_" + material + "_" + item), Identifier.of("medievalweapons:offhand"), 1.0f))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "mace" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "ninjato" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item));
            case "rapier" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "sickle" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            case "small_axe" -> ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/" + material + "_" + item))
                    .addOverride(ModelOverrideBuilder.of(Identifier.of("medievalweapons:item/" + material + "_" + item + "_gui"), Identifier.of("medievalweapons:gui"), 1.0f))
            ...
            default -> throw new IllegalStateException("Could not find ModelJsonBuilder!");
        };
    }
    ...
    public static ModelJsonBuilder getGuiModelJsonBuilder(String item, String material) {
        return ModelJsonBuilder.create("item/handheld").addTexture(TextureKey.LAYER0, Identifier.of("medievalweapons:item/extra/" + material + "_" + item));
    }
