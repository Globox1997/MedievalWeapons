...
public enum Javelin_Item_Renderer {
    ...
    private final Javelin_Entity_Model javelinEntityModel = new Javelin_Entity_Model(Javelin_Entity_Model.getTexturedModelData().createModel());
    ...
    public boolean render(LivingEntity entity, ItemStack stack, ModelTransformation.Mode renderMode, boolean leftHanded, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light,
        ...
        VertexConsumer vertexConsumer = ItemRenderer.getItemGlintConsumer(vertexConsumers,
                this.javelinEntityModel.getLayer(Javelin_Entity_Renderer.getTexture(((Javelin_Item) stack.getItem()).getType())), false, stack.hasGlint());
