...
public enum Mace_Item_Renderer {
    ...
    private final Mace_Entity_Model mace_Entity_Model = new Mace_Entity_Model(Mace_Entity_Model.getTexturedModelData().createModel());
    ...
    public boolean render(LivingEntity entity, ItemStack stack, ModelTransformation.Mode renderMode, boolean leftHanded, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light,
        ...
        VertexConsumer vertexConsumer = ItemRenderer.getItemGlintConsumer(vertexConsumers,
                this.mace_Entity_Model.getLayer(new Identifier("medievalweapons", "textures/entity/" + stack.getItem() + ".png")), false, stack.hasGlint());
