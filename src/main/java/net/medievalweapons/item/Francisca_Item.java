...
public class Francisca_Item extends SwordItem {
    ...
    public Francisca_Item(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Supplier<EntityType<Francisca_Entity>> typeSupplier, Settings settings) {
