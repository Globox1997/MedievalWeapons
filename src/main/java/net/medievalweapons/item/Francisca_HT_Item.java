...
public class Francisca_HT_Item extends Item implements Vanishable {
  ...
  public Francisca_HT_Item(ToolMaterial material, float attackDamage, float attackSpeed,
      Supplier<EntityType<Francisca_HT_Entity>> typeSupplier, Item.Settings settings) {
    ...
    if (user instanceof PlayerEntity) {
      ...
      if (i >= 10) {
        if (!world.isClient) {
          ...
          francisca_HT_Entity.setProperties(playerEntity, playerEntity.getPitch(), playerEntity.getYaw(), 0.0F, 1.5F,
              1.0F);
          ...
          world.playSoundFromEntity(null, francisca_HT_Entity, SoundEvents.ITEM_TRIDENT_THROW, SoundCategory.PLAYERS,
              1.0F, 1.0F);
          if (!playerEntity.isCreative()) {
