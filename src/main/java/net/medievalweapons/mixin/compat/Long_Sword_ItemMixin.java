...
public abstract class Long_Sword_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Long_Sword_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
