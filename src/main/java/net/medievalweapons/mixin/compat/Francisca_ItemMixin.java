...
@Mixin(Francisca_Item.class)
public abstract class Francisca_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Francisca_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
