...
public abstract class Mace_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Mace_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
