...
@Mixin(SmallAxeItem.class)
public abstract class SmallAxeItemMixin extends SwordItem implements InitialStackStateProvider {

    public SmallAxeItemMixin(ToolMaterial toolMaterial, Settings settings) {
