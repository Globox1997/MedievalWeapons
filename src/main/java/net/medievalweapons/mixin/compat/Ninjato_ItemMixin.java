...
@Mixin(Ninjato_Item.class)
public abstract class Ninjato_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Ninjato_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
