...
public abstract class Javelin_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Javelin_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
