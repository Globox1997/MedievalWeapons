...
public abstract class Dagger_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Dagger_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
