...
@Mixin(DaggerItem.class)
public abstract class DaggerItemMixin extends SwordItem implements InitialStackStateProvider {

    public DaggerItemMixin(ToolMaterial toolMaterial, Settings settings) {
