...
@Mixin(Lance_Item.class)
public abstract class Lance_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Lance_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
