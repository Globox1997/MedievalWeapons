...
@Mixin(BigAxeItem.class)
public abstract class BigAxeItemMixin extends SwordItem implements InitialStackStateProvider {

    public BigAxeItemMixin(ToolMaterial toolMaterial, Settings settings) {
    ...
    //         EnchantmentHelper.set(itemStack, defaultEnchants);
    //     }
    // }
