...
public abstract class Small_Axe_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Small_Axe_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
