...
public abstract class MaceItemMixin extends SwordItem implements InitialStackStateProvider {

    public MaceItemMixin(ToolMaterial toolMaterial, Settings settings) {
