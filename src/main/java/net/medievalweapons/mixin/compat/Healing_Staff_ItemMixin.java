...
public abstract class Healing_Staff_ItemMixin extends SwordItem implements InitialStackStateProvider {

    public Healing_Staff_ItemMixin(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
