...
@Mixin(HealingStaffItem.class)
public abstract class HealingStaffItemMixin extends SwordItem implements InitialStackStateProvider {

    public HealingStaffItemMixin(ToolMaterial toolMaterial, Settings settings) {
