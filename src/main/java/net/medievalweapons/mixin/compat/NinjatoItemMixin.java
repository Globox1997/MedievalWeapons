...
@Mixin(NinjatoItem.class)
public abstract class NinjatoItemMixin extends SwordItem implements InitialStackStateProvider {

    public NinjatoItemMixin(ToolMaterial toolMaterial, Settings settings) {
