...
@Mixin(RapierItem.class)
public abstract class RapierItemMixin extends SwordItem implements InitialStackStateProvider {

    public RapierItemMixin(ToolMaterial toolMaterial, Settings settings) {
