...
public class Francisca_LT_Entity extends PersistentProjectileEntity {
    ...
    public Francisca_LT_Entity(EntityType<? extends Francisca_LT_Entity> entityType, World world, Francisca_LT_Item item) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        float damage = ((Francisca_LT_Item) this.francisca_LT.getItem()).getAttackDamage() * 2.3F;
