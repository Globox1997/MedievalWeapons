...
public class HealingBallEntity extends ThrownEntity {
    private int addition = 0;

    public HealingBallEntity(EntityType<? extends HealingBallEntity> entityType, World world) {
        super(entityType, world);
    }

    public HealingBallEntity(EntityType<? extends HealingBallEntity> entityType, double d, double e, double f, World world) {
        super(entityType, d, e, f, world);
    }

    public HealingBallEntity(LivingEntity livingEntity, World world, int addition) {
        super(EntityInit.HEALING_BALL_ENTITY, livingEntity, world);
        this.addition = addition;
    }

    @Environment(EnvType.CLIENT)
    public HealingBallEntity(World world, double x, double y, double z, double directionX, double directionY, double directionZ) {
