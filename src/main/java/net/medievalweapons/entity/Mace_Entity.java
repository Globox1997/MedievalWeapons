...
public class Mace_Entity extends Entity {
    private static final TrackedData<Boolean> ENCHANTMENT_GLINT;
    private ItemStack stack;;

    public Mace_Entity(EntityType<?> type, World world) {
        super(type, world);
    }

    public Mace_Entity(EntityType<? extends Mace_Entity> entityType, World world, Mace_Item item) {
    ...
    protected void writeCustomDataToTag(CompoundTag tag) {
        tag.put("mace", this.stack.toTag(new CompoundTag()));
    }
    ...
    static {
        ENCHANTMENT_GLINT = DataTracker.registerData(Mace_Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
